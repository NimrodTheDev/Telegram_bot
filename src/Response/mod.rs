...
pub fn about_sei(response: &Coin_Data::CoinGeckoResponse) -> String {
...
pub fn community(response: &Coin_Data::CoinGeckoResponse) -> String {
...
pub fn Help()-> String{
    ...
    📌 How to get started?
     1️⃣ Follow us on Twitter for updates and exclusive content! 👉 https://x.com/Iam_ebimo
